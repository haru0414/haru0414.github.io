...
const zh = {
  translation: {
    ...
    perf: {
      ...
      transition: {
        title: "先讓使用者打得動字",
        desc: "在 20,000 筆資料上做即時過濾，最多渲染 1,200 筆到畫面上。開關決定「過濾與重畫列表」要不要被排到低優先權——輸入框的更新永遠優先，重運算讓路。",
        hint: "關掉再快速打字，輸入框會跟不上你的手。打開後列表會先變淡再更新，但打字始終順暢。「卡住畫面」那欄超過 60ms 就是使用者感覺得到的延遲。",
        placeholder: "輸入關鍵字試試，例如 render",
        lag: "卡住畫面",
        hits: "顯示 {{n}} 筆 / 共 {{total}} 筆",
      },
      rate: {
        title: "把事件次數降下來",
